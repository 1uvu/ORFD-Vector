...
from Core.classific import classific
from Core.preprocess import digital, category
from setting import COLUMNS
...
def main(input_data, name="rf"):
	...
	:return: 处理结果、其他描述信息
	'''
	data, desc = data_main(input_data, step=0)
	result = classific(data, name=name)
